...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi NonText ctermbg=0 ctermfg=7 cterm=NONE guibg=#202020 guifg=#616161 gui=NONE
    hi Comment ctermbg=0 ctermfg=8 cterm=italic guibg=#202020 guifg=#3a3a3a gui=italic
    ...
    hi Identifier ctermbg=0 ctermfg=11 cterm=NONE guibg=#202020 guifg=#f2cda7 gui=NONE
    hi Ignore ctermbg=0 ctermfg=15 cterm=NONE guibg=#202020 guifg=#dfdfdf gui=NONE
    hi PreProc ctermbg=0 ctermfg=8 cterm=NONE guibg=#202020 guifg=#3a3a3a gui=NONE
    ...
    hi Number ctermbg=0 ctermfg=2 cterm=NONE guibg=#202020 guifg=#96a171 gui=NONE
    ...
    hi StatusLineNC ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE
    hi VertSplit ctermbg=0 ctermfg=8 cterm=NONE guibg=#202020 guifg=#3a3a3a gui=NONE
    hi TabLine ctermbg=0 ctermfg=8 cterm=NONE guibg=#202020 guifg=#3a3a3a gui=NONE
    hi TabLineFill ctermbg=0 ctermfg=15 cterm=NONE guibg=#202020 guifg=#dfdfdf gui=NONE
    hi TabLineSel ctermbg=7 ctermfg=0 cterm=NONE guibg=#616161 guifg=#202020 gui=NONE
    hi Title ctermbg=0 ctermfg=1 cterm=NONE guibg=#202020 guifg=#EA7171 gui=NONE
    hi CursorLine ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE
    hi LineNr ctermbg=0 ctermfg=8 cterm=NONE guibg=#202020 guifg=#3a3a3a gui=NONE
    hi CursorLineNr ctermbg=0 ctermfg=15 cterm=NONE guibg=#202020 guifg=#dfdfdf gui=NONE
    hi helpLeadBlank ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE
    hi helpNormal ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE
    hi Visual ctermbg=7 ctermfg=0 cterm=NONE guibg=#616161 guifg=#202020 gui=NONE
    hi VisualNOS ctermbg=7 ctermfg=0 cterm=NONE guibg=#616161 guifg=#202020 gui=NONE
    hi Pmenu ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE
    hi PmenuSbar ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE
    hi PmenuSel ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE
    hi PmenuThumb ctermbg=15 ctermfg=8 cterm=NONE guibg=#dfdfdf guifg=#3a3a3a gui=NONE
    hi FoldColumn ctermbg=15 ctermfg=8 cterm=NONE guibg=#dfdfdf guifg=#3a3a3a gui=NONE
    hi Folded ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE
    hi WildMenu ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE
    hi SpecialKey ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE
    ...
    hi DiffText ctermbg=0 ctermfg=11 cterm=NONE guibg=#202020 guifg=#f2cda7 gui=NONE
    ...
    hi Directory ctermbg=0 ctermfg=7 cterm=NONE guibg=#202020 guifg=#616161 gui=NONE
    hi MatchParen ctermbg=0 ctermfg=14 cterm=NONE guibg=#202020 guifg=#9fbfaf gui=NONE
    hi SpellBad ctermbg=8 ctermfg=9 cterm=NONE guibg=#3a3a3a guifg=#ed8682 gui=NONE guisp=#ed8682
    hi SpellCap ctermbg=8 ctermfg=11 cterm=NONE guibg=#3a3a3a guifg=#f2cda7 gui=NONE guisp=#9fb8bf
    hi SpellLocal ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE guisp=#d095a9
    hi SpellRare ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE guisp=#9fbfaf
    hi ColorColumn ctermbg=15 ctermfg=8 cterm=NONE guibg=#dfdfdf guifg=#3a3a3a gui=NONE
    hi SignColumn ctermbg=15 ctermfg=8 cterm=NONE guibg=#dfdfdf guifg=#3a3a3a gui=NONE
    ...
    hi MoreMsg ctermbg=7 ctermfg=0 cterm=NONE guibg=#616161 guifg=#202020 gui=NONE
    hi Question ctermbg=0 ctermfg=8 cterm=NONE guibg=#202020 guifg=#3a3a3a gui=NONE
    hi Cursor ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE
    hi CursorColumn ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE
    hi QuickFixLine ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE
    hi Conceal ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE
    hi ToolbarLine ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE
    hi ToolbarButton ctermbg=8 ctermfg=15 cterm=NONE guibg=#3a3a3a guifg=#dfdfdf gui=NONE
    hi debugPC ctermbg=7 ctermfg=0 cterm=NONE guibg=#616161 guifg=#202020 gui=NONE
    hi debugBreakpoint ctermbg=8 ctermfg=10 cterm=NONE guibg=#3a3a3a guifg=#b1d094 gui=NONE
    ...
    hi pythonConditional ctermbg=0 ctermfg=14 cterm=italic guibg=#202020 guifg=#9fbfaf gui=italic
    hi pythonDecorator ctermbg=0 ctermfg=6 cterm=NONE guibg=#202020 guifg=#80ab96 gui=NONE
    ...
    hi pythonFunctionCall ctermbg=0 ctermfg=11 cterm=italic guibg=#202020 guifg=#f2cda7 gui=italic
    hi pythonImport ctermbg=0 ctermfg=12 cterm=italic guibg=#202020 guifg=#9fb8bf gui=italic
    hi pythonNone ctermbg=0 ctermfg=8 cterm=italic guibg=#202020 guifg=#3a3a3a gui=italic
    ...
    hi pythonOperator ctermbg=0 ctermfg=14 cterm=italic guibg=#202020 guifg=#9fbfaf gui=italic
...
let g:terminal_ansi_colors = [ '#202020', '#EA7171', '#96a171', '#ebb47b', '#7196a1', '#c28490', '#80ab96', '#616161', '#3a3a3a', '#ed8682', '#b1d094', '#f2cda7', '#9fb8bf', '#d095a9', '#9fbfaf', '#dfdfdf', ]
